...
const PARISH_LIFE_POSTS = [
  ...
  },
  {
  ...
  },
   {
    ...
    body: 'As announced last November, with the blessing of Metropolitan Nathanael, the support of the parish council and the Archdiocese Presbyters Council, I was awarded a three-month sabbatical which I will take August 16 to November 16 this year. This will be my first sabbatical in 31 years of service, and I thank everyone for their prayerful support.    A sabbatical is an extended period of time away from one’s usual work to devote to research and/or rest. The primary purpose is to recharge and return to work rejuvenated and invigorated.    Even though the Archdiocese and Uniform Parish Regulations provide for a three-month sabbatical for every six years of continuous service in a parish, very few priests take them. In addition, Hierarchs and parish communities rarely encourage their clergy to take a sabbatical.    Because I have already earned my doctoral degree, and because I have many certifications in law enforcement and disaster chaplaincy, I will not be doing any academic research or study. At the strong encouragement of His Eminence, the coordinator of the APC program, and the few clergy who previously took sabbaticals, I will be devoting my time to rest, recreation, and travel.    An important component of the sabbatical is complete disconnection from parish duties. Thus, I will be absent from all parish events including worship, sacraments and administration, I will not be checking my work email, I will not be answering phone calls and texts. Our associate priest, Fr. Peter Sarolas, will fulfil the priestly duties in my absence. Fr. Peter will be supported by the parish council, our local vicar, the chancellor’s office and Metropolitan Nathanael if the need arises.    Again, I want to thank everyone for their understanding and support to take my sabbatical.',
  },
  {
