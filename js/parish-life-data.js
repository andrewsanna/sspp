...
const PARISH_LIFE_POSTS = [
  ...
  },
  {
   ...
   {
    id: 'parish-health-plan-2025',
    category: 'message',
    title: 'Parish Health Plan',
    date: 'September 25, 2025',
    author: 'Fr. Rick Andrews',
    excerpt: 'Fr. Rick and the Parish Council initiated the Parish Health Team (PHT) in 2025 to create a Parish Health Plan that would guide the parish into 2026 and beyond.',
    body: 'The approach was informed by a year-long study of Reclaiming the Great Commission: A Roadmap to Parish Health that culminated in a workshop with Fr. Armatas in October 2024. Through the work in 2025, the PHT incorporated and updated much of the 2015 Strategic Plan “Reaching Forward to what Lies Ahead: Vision 2025”.The small PHT consisted of 10 members representing a cross-section of SSPP consolidated available input and feedback to realign and streamline the Parish Health Plan with a focus on 2026, a horizon of three years, and an intent for annual reporting and updating. The outcome was reviewed and adopted by the parish council in October 2025 and presented to the Parish Assembly that November. Parish Health Team, 2025: Keith Anderson (chair), Fr. Rick Andrews, Angie Katsamakis, Steve Koulogeorge, Sophia Castleberry, Joy Logothetis, John Mackris, Elias Matsakis, George Nassos, Maryann Rasmussen, Fr. Peter Sarolas',
  },
  {
  ...
  },
  {
    ...
    date: 'June 7, 2026',
    excerpt: 'Philoptochos shares a summer update on Greek Fest baking days and a call for ideas as the board plans the year ahead.',
